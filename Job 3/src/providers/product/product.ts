...
export class ProductProvider {
 ...
 .then((db: SQLiteObject) => {
  ...
  .then(() => console.log('Product berhasil ditambahkan!'))
  ...
  .catch(e => console.error('Product gagal diubah: ',
 e));
  })
  .catch((e) => console.error(e));
  }
  ...
  let params = [id];
  return db.executeSql(sql, params)
  .then(() => console.log('Product berhasil dihapus!'))
  .catch(e => console.error('Product gagal dihapus: ',
 e));
  })
  .catch((e) => console.error(e));
  }
 ...
 .catch(e => console.error('Product gagal diambil: ',
e));
 })
 .catch((e) => console.error(e));
 }
 ...
 .catch(e => console.error('Product gagal diload: ',
e));
 })
 .catch((e) => console.error(e));
 }
